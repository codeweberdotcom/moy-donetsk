...
<div class="floating-menu" >
   ...
   <a <?php echo $Main->modalAuth(["attr"=>'class="open-modal menu-open-modal-chat" href="#" data-id-modal="modal-chat-user"']); ?> >
    <div>
      <div class="floating-menu-icon" >
...
<div class="mb20 mt20 h4"> <strong> Объявления в других городах </strong> </div>
    <div class="row">
