...
<body>
    <div class="container">
        ...
        $rules = [
            ...
            '/На Авито вы можете недорого/u' => 'Недорого',
            '/Выбирайте среди предложений магазинов и частных объявлений/u' => 'Предложения магазинов и частные объявления',
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $pattern = '/:\s*\d[\d\s]*\s*объявлени(й|я|е)\./';
            $replacement = '.';
            $inputText = preg_replace($pattern, $replacement, $inputText);
