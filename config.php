...
return [
   ...
   "https" => true,
   "private_hash" => "d7e3d09c960ee5e0dfe442d7f7ba9003",
   "private_hex" => "e7258c78fda6515fa0eee0f603425bb6",
   "feed_ads_key" => "8808698891",
   "cron_key" => "6166929240",
   "api_key" => "8906286475",
   "folder_admin" => "cp_667583ff022b5",
   "basePath" => __dir__,
   "urlPrefix" => "/",
   "urlPath" => "https://moy-donetsk.ru",
   ...
   "db" => [
     "port" => "",
     "host" => "localhost",
     "database" => "admin_moydonetsk",
     "user" => "admin_moydonetsk",
     "pass" => "0Cx969~bd",
     "charset" => "utf8",
   ],
